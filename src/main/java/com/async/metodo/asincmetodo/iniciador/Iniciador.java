...
public class Iniciador implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        CompletableFuture<String> atencion1 = servicioAtencion.atender(new Paciente("Juan", "Gripa"));
        CompletableFuture<String> atencion2 = servicioAtencion.atender(new Paciente("Miguel", "Dolor de cabeza"));
        CompletableFuture<String> atencion3 = servicioAtencion.atender(new Paciente("Marta", "Alergía"));
        CompletableFuture<String> atencion4 = servicioAtencion.atender(new Paciente("Camila", "Mareos"));
